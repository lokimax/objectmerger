...
class AverageValueStrategyTest {
    ...
    void testAverageWithLongValues() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn(1000L);
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn(2000L);
    ...
    void testAverageThrowsExceptionForNonNumeric() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("John");
    ...
    void testAverageWithMixedNumericTypes() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn(10);      // Integer
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn(20L);     // Long
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn(30.0);    // Double
