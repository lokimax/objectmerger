...
class ConcatenateStrategyTest {
    ...
    void testConcatenateWithDefaultDelimiter() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("java");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn("spring");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn("boot");
    ...
    void testConcatenateRespectsPriority() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("first");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn("second");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn("third");
    ...
    void testConcatenateSkipsNullValues() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("python");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn(null);
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn("javascript");
    ...
    void testConcatenateWithSingleValue() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("technology");
    ...
    void testConcatenateWithPriorityAndNulls() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("java");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn(null);
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn("spring");
    ...
    void testConcatenateWithEmptyStrings() {
        ...
        try (MockedStatic<ObjectMerger> mockedObjectMerger = mockStatic(ObjectMerger.class)) {
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source1, fieldName)).thenReturn("start");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source2, fieldName)).thenReturn("");
            mockedObjectMerger.when(() -> ObjectMerger.getFieldValue(source3, fieldName)).thenReturn("end");
