...
@DisplayName("GraalJS Sandbox Security Tests")
class GraalJsSandboxTest {
    ...
    class LegitimateExpressionsAreAllowed {
        @Test
        void arithmetic() {
            // GraalJS returns Integer for simple int math usually.
            assertAllowed("1 + 1", 2);
        }
    }
    ...
    class ReflectionBlocked {
        ...
        void blocksGetClassLoader() {
            // .class is not available on Java objects in JS unless enabled
