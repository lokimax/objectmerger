...
class ClassLoadingGuardTest {
    ...
    class DangerousClassesAreBlocked {
        ...
        void blocksProcessBuilderClass() {
            assertThrows(
                    ...
                    () -> guard.loadClassSafely("java.lang.ProcessBuilder"));
        }
        ...
        void blocksNioFileClass() {
            assertThrows(
                    SecurityException.class, () -> guard.loadClassSafely("java.nio.file.Files"));
        }
        ...
        void blocksReflectionClass() {
            assertThrows(
                    SecurityException.class,
                    () -> guard.loadClassSafely("java.lang.reflect.Method"));
        }
        ...
        void blocksJavaxClass() {
            assertThrows(
                    SecurityException.class,
                    () -> guard.loadClassSafely("javax.script.ScriptEngineManager"));
        }
        ...
        void blocksConcurrentClass() {
            assertThrows(
                    SecurityException.class,
                    () -> guard.loadClassSafely("java.util.concurrent.Executors"));
        }
    }
    ...
    class UnlistedPackagesAreBlocked {
        ...
        void blocksArbitraryThirdPartyClass() {
            assertThrows(
                    SecurityException.class,
                    () -> guard.loadClassSafely("org.apache.commons.io.FileUtils"));
        }

        @Test
        void blocksClassOutsideWhitelist() {
            assertThrows(
                    SecurityException.class, () -> guard.loadClassSafely("com.example.SomeClass"));
        }
    }
