...
class ObjectMergerServiceIntegrationTest {
        ...
        @Autowired
        private ObjectMergerService mergerService;
        ...
        void testMergePerson() throws ClassNotFoundException {
                ...
                List<LabeledSource<?>> sources = Arrays.asList(
                                new LabeledSource<>("source1", person1),
                                new LabeledSource<>("source2", person2));
        ...
        void testMergeWithUnlistedClass() {
                ...
                List<LabeledSource<?>> sources = Collections.singletonList(new LabeledSource<>("source1", person));
        ...
        void testMergeWithEmptySources() throws ClassNotFoundException {
                ...
                Object result = mergerService.merge("de.x132.objectmerger.model.Person", definition, emptySources);
