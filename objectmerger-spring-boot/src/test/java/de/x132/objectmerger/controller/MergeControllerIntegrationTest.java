...
class MergeControllerIntegrationTest {
  ...
  void testMergeWithPriorityStrategy() throws Exception {
    ...
    definition.put(
        "name", Map.of("strategy", "priority", "priority", Map.of("database", 1, "crm", 2)));
  ...
  void testMergeWithNullValues() throws Exception {
    ...
    definition.put(
        "age", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
    definition.put(
        "email", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
    definition.put(
        "phone", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
    request.setDefinition(definition);
  ...
  void testMergeWithComplexPriority() throws Exception {
    ...
    definition.put(
        "phone",
        Map.of(
            "strategy", "priority", "priority", Map.of("crm", 1, "database", 2, "analytics", 3)));
    request.setDefinition(definition);
