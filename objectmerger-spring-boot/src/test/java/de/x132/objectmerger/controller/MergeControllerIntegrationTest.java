...
class MergeControllerIntegrationTest {
  ...
  void testHealthEndpoint() throws Exception {
    mockMvc
        .perform(get("/api/v1/merge/health"))
  ...
  void testExampleEndpoint() throws Exception {
    mockMvc
        .perform(post("/api/v1/merge/example"))
        .andExpect(status().isOk())
  ...
  void testMergeWithPriorityStrategy() throws Exception {
    ...
    definition.put("name", Map.of("priority", Map.of("database", 1, "crm", 2)));
    definition.put("age", Map.of("strategy", "maximum"));
    definition.put("email", Map.of("priority", Map.of("database", 1)));
    definition.put("phone", Map.of("priority", Map.of("crm", 1)));
    ...
    List<LabeledSourceDTO> sources =
        Arrays.asList(
            new LabeledSourceDTO("database", dbSource), new LabeledSourceDTO("crm", crmSource));
  ...
  void testMergeWithMaximumStrategy() throws Exception {
    ...
    Map<String, Map<String, Object>> definition = new LinkedHashMap<>();
    definition.put("name", Map.of("priority", Map.of("source1", 1)));
    definition.put("age", Map.of("strategy", "maximum"));
    definition.put("email", Map.of("priority", Map.of("source1", 1)));
    definition.put("phone", Map.of("priority", Map.of("source1", 1)));
    request.setDefinition(definition);
  ...
  void testMergeWithMinimumStrategy() throws Exception {
    ...
    List<LabeledSourceDTO> sources =
        Arrays.asList(
            new LabeledSourceDTO("source1", source1), new LabeledSourceDTO("source2", source2));
    request.setSources(sources);
  ...
  void testMergeWithNullValues() throws Exception {
    ...
    Map<String, Map<String, Object>> definition = new LinkedHashMap<>();
    definition.put("name", Map.of("priority", Map.of("source1", 1, "source2", 2)));
    definition.put("age", Map.of("priority", Map.of("source1", 1, "source2", 2)));
    definition.put("email", Map.of("priority", Map.of("source1", 1, "source2", 2)));
    definition.put("phone", Map.of("priority", Map.of("source1", 1, "source2", 2)));
    request.setDefinition(definition);
  ...
  void testMergeWithComplexPriority() throws Exception {
    ...
    Map<String, Map<String, Object>> definition = new LinkedHashMap<>();
    definition.put("name", Map.of("priority", Map.of("database", 1, "crm", 2, "analytics", 3)));
    definition.put("age", Map.of("strategy", "maximum"));
    definition.put("email", Map.of("priority", Map.of("analytics", 1, "crm", 2, "database", 3)));
    definition.put("phone", Map.of("priority", Map.of("crm", 1, "database", 2, "analytics", 3)));
    request.setDefinition(definition);
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.email").value("analytics@example.com")) // analytics has priority 1
