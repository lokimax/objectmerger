...
class MergeControllerIntegrationTest {
    ...
    void testMergeWithPriorityStrategy() throws Exception {
        ...
        definition.put("name", Map.of("strategy", "priority", "priority", Map.of("database", 1, "crm", 2)));
    ...
    void testMergeWithNullValues() throws Exception {
        ...
        Map<String, Map<String, Object>> definition = new LinkedHashMap<>();
        definition.put("name", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
        definition.put("age", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
        definition.put("email", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
        definition.put("phone", Map.of("strategy", "priority", "priority", Map.of("source1", 1, "source2", 2)));
        request.setDefinition(definition);
    ...
    void testMergeWithComplexPriority() throws Exception {
        ...
        Map<String, Map<String, Object>> definition = new LinkedHashMap<>();
        definition.put("name",
                Map.of("strategy", "priority", "priority", Map.of("database", 1, "crm", 2, "analytics", 3)));
        definition.put("age", Map.of("strategy", "maximum"));
        definition.put("email",
                Map.of("strategy", "priority", "priority", Map.of("analytics", 1, "crm", 2, "database", 3)));
        definition.put("phone",
                Map.of("strategy", "priority", "priority", Map.of("crm", 1, "database", 2, "analytics", 3)));
        request.setDefinition(definition);
