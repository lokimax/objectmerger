...
class MvelSandboxTest {
  ...
  class LegitimateExpressionsAreAllowed {
    ...
    void stringConcatenationAllowed() {
      List<LabeledSource<?>> sources =
          Arrays.asList(
              new LabeledSource<>("first", "Hello"), new LabeledSource<>("second", " World"));
      MvelFieldDefinition fieldDef =
          MvelFieldDefinition.builder().expression("sources['first'] + sources['second']").build();
  ...
  class ArbitraryObjectCreationIsBlocked {
    ...
    void blocksScriptEngineCreation() {
      assertExpressionIsBlocked("new javax.script.ScriptEngineManager().getEngineByName('js')");
    }
  }
  ...
  class DirectExpressionValidation {
    ...
    void runtimeReferenceFailsValidation() {
      assertThrows(
          SecurityException.class, () -> MvelSandbox.validateExpression("Runtime.getRuntime()"));
    }
    ...
    void newInstanceCallFailsValidation() {
      assertThrows(
          SecurityException.class, () -> MvelSandbox.validateExpression("something.newInstance()"));
    }
