...
public class MultiSourceMergeTest {
  ...
  void testMergePersonData() throws Exception {
    ...
    Person crmPerson =
        gson.fromJson(new FileReader("src/test/resources/person/crm-person.json"), Person.class);
    Person dbPerson =
        gson.fromJson(new FileReader("src/test/resources/person/db-person.json"), Person.class);
    MergeDefinition mergeDefinition =
        gson.fromJson(
            new FileReader("src/test/resources/person/person-merge-definition.json"),
