...
class MapPersonMergeTest {
    ...
    void testMergePersonDataWithMvel() throws Exception {
        Map<String, Object> analyticsPerson = gson.fromJson(
                new FileReader("src/test/resources/person/analytics-person.json"), Map.class);
        Map<String, Object> crmPerson = gson.fromJson(
                new FileReader("src/test/resources/person/crm-person.json"), Map.class);
        Map<String, Object> dbPerson = gson.fromJson(
        ...
        // Perform the merge
        Map<String, Object> mergedPerson = ObjectMerger.merge(
                mergeDefinition,
