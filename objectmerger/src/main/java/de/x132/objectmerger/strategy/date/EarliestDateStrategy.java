...
public class EarliestDateStrategy implements MergeStrategy<Object, FieldDefinition> {

  public static final String NAME = "earliestDate";
  ...
  public Object merge(List<LabeledSource<?>> sources, FieldDefinition fieldDef, String fieldName) {
    return sources.stream()
        ...
        .orElseGet(fieldDef::getDefaultValue);
  }
}
